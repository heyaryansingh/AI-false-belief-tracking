"""Episode recorder for VirtualHome episodes (Parquet/JSONL serialization)."""
...
class VirtualHomeEpisodeRecorder:
    """Recorder for saving VirtualHome episodes to Parquet or JSONL format.
    
    Compatible with GridHouse episode format for unified analysis.
    """
    ...
    def _step_to_dict(self, step: EpisodeStep, episode: Episode) -> Dict[str, Any]:
        ...
        Uses same format as GridHouseEpisodeRecorder for compatibility.
        """
